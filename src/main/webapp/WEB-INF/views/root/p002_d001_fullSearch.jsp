						...
						<c:otherwise>
							<table class="table table-hover">
								...
								<c:forEach var="i" begin="0" end="${(fn:length(searchResult.c_articleList))-1 }">
										<tr class="C_ARTICLE clickArea" id="${searchResult.c_articleList[i].CA_ID }">
											<td>
