...
//				for(int j=0; i<vo.getArticleList()ze();j++) {
//					if(vo.getArticleList().get(i).getArticleImg() != null) {
//						encoded = Base64.getEncoder().encode(vo.getArticleList().get(i).getArticleImg().get(j));
//						List<String> encodedString = new ArrayList<String>();
//						encodedString.add(new String(encoded));
