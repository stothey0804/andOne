...
public class ClubP003_d003ControllerImpl implements ClubP003_d003Controller{
	...
	public void insertReply(@RequestParam(value = "ca_id",required = true) String ca_id,@RequestParam(value="car_content",required=true) String car_content,@RequestParam(value="p_car_id",required = false) String p_car_id,HttpSession session) {
