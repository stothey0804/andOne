...
public interface MemberP002_d002Controller {
	//신규문의
	public ModelAndView searchNewQnA(Map<String, String> param, int curPage, HttpServletRequest request);
	//전체문의
	public ModelAndView searchAllQnA(Map<String, String> param, int curPage, HttpServletRequest request);
	//디테일 조회
